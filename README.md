...
This repository hold everything needed to build a mirrorbits docker image based on [videolabs/mirroribts](https://github.com/videolabs/mirrorbits/). To build this image, you can run `make build`.
...
* [Project](https://github.com/videolabs/mirrorbits/)
